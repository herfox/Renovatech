<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default_orig.aspx.cs" Inherits="_Default" %>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1"> Ofrecemos soluciones que maximizan la rentabilidad de su negocio con ética, innovación, calidad y excelencia</h1>
                                    <h2 class="animation animated-item-2">¡Renovatech es el impulso que le hacia falta a su negocio!</h2>
